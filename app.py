...
model_path = "model_indoBERT_best.pth"
if not os.path.exists(model_path):
    gdown.download(
        id="1xHm6U9KT5J__YJmNvKHhoe4bip9qBO7x", 
...
# --- Konfigurasi Halaman ---
st.set_page_config(page_title="Deteksi Berita Hoaks", page_icon="favicon.png", layout="centered")
